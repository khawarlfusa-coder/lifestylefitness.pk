...
import { Youtube, Instagram, Phone, Award, ShieldCheck, Dumbbell, Heart } from "lucide-react";
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 pb-12 border-b border-white/10">
          ...
          <div className="md:col-span-5 space-y-4">
            <div className="flex items-center gap-3.5">
              <div className="w-12 h-12 rounded-full overflow-hidden p-0.5 bg-gradient-to-tr from-yellow-400 to-amber-500 shadow-lg shadow-yellow-500/20 shrink-0">
                <img
              ...
              <div>
                <span className="text-xl font-black text-white tracking-tight font-heading">
                  LIFESTYLE <span className="text-gradient-emerald">FITNESS PK</span>
                </span>
          ...
          <div className="md:col-span-3 space-y-3">
            ...
            <ul className="space-y-2.5 font-medium">
              <li>
                <button onClick={() => setActiveTab("calculators")} className="hover:text-brand-300 transition-colors">
                  BMI & Ideal Weight Calculator
                </button>
              </li>
              <li>
                <button onClick={() => setActiveTab("ai-scanner")} className="hover:text-brand-300 transition-colors">
                  AI Food Picture Calorie Meter
                </button>
              </li>
              <li>
                <button onClick={() => setActiveTab("store")} className="hover:text-brand-300 transition-colors">
                  Matcha Tea & Chia Seeds Store
                </button>
              </li>
              <li>
                <button onClick={() => setActiveTab("videos")} className="hover:text-brand-300 transition-colors">
                  Weight Loss Video Library
                </button>
              </li>
              <li>
                <button onClick={() => setActiveTab("chat")} className="hover:text-brand-300 transition-colors">
                  1-on-1 Consultation
                </button>
              </li>
            </ul>
          ...
          <div className="md:col-span-4 space-y-3">
            ...
            <p className="text-[11px] text-slate-500">
              Cash on Delivery (COD) available across Karachi, Lahore, Islamabad, Rawalpindi, Faisalabad and all cities in Pakistan.
            </p>
          </div>
